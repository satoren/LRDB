...
var DebuggableLuaInit = (function() {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  if (typeof __filename !== 'undefined') _scriptDir = _scriptDir || __filename;
  return (
function(DebuggableLuaInit) {
  DebuggableLuaInit = DebuggableLuaInit || {};
...
var Module = typeof DebuggableLuaInit !== 'undefined' ? DebuggableLuaInit : {};
...
var wasmBinaryFile = 'node_lua_with_lrdb.wasm';
...
var ASM_CONSTS = {
  ...
  var Asyncify={State:{Normal:0,Unwinding:1,Rewinding:2},state:0,StackSize:65535,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToName:{},callStackId:0,afterUnwind:null,asyncFinalizers:[],sleepCallbacks:[],getCallStackId:function(funcName) {
...
if (!Object.getOwnPropertyDescriptor(Module, "NODERAWFS")) Module["NODERAWFS"] = function() { abort("'NODERAWFS' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
...
run();
  ...
  return DebuggableLuaInit.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = DebuggableLuaInit;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return DebuggableLuaInit; });
else if (typeof exports === 'object')
  exports["DebuggableLuaInit"] = DebuggableLuaInit;
